...
My research interests primarily lie in recommender systems, with a focus on developing machine learning models that can reason over richly-labeled relational structures, graphs, and networks. I am particularly interested in applying graph neural networks and large language models to build multi-modal foundation models.
